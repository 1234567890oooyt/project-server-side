...
function Article(props) {
  ...
  <div class="item item-4">Контент 4</div>
          ...
          <div class="v2_grid-container">
            ...
            <div className="box_image" style={{ backgroundImage: `url(${process.env.REACT_APP_BASE_URL}/images/31.png)`, backgroundSize: 'cover', }}></div>
            <div className="box_more_info">Більше</div>
              </div>
            <div class="box"><div className="box_num">2</div>
            <div className="box_text">Lorem, ipsum dolor.</div>
            <div className="box_image" style={{ backgroundImage: `url(${process.env.REACT_APP_BASE_URL}/images/32.png)`, backgroundSize: 'cover',}}></div>
            <div className="box_more_info">Більше</div>
            </div>
            
            <div class="box"><div className="box_num">3</div>
            <div className="box_text">Lorem, ipsum dolor.</div>
            <div className="box_image" style={{ backgroundImage: `url(${process.env.REACT_APP_BASE_URL}/images/33.png)` , backgroundSize: 'cover', }}></div>
            <div className="box_more_info">Більше</div>
            </div>
          </div>
